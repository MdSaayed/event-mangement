            ...
            <AosAnimation>
                <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 py-20 max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col justify-center gap-4 px-12 mt-12 lg:mt-0 items-center lg:items-start">
                        <h1 data-aos="fade-up" data-aos-delay="500" className="text-4xl font-bold text-white text-center lg:text-right">Discover the Artistry of Entertainment Event Management</h1>
                        <p data-aos="fade-up" data-aos-delay="1000" className="text-white text-center lg:text-right"> Welcome to Your Company Name, where entertainment meets excellence. We specialize in curating and managing entertainment events that leave a lasting impression. With a team of seasoned professionals, we bring your event ideas to life, from concept to execution.</p>
                        <div data-aos="fade-up" data-aos-delay="1500" className="flex gap-4">
