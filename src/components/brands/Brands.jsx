    ...
    return (
        <div  className="max-w-6xl mx-auto pb-16">
            ...
            <div className="flex flex-wrap gap-4 justify-center items-center mx-auto">
                ...
                <img className="w-1/6 h-[3.2rem]" src="https://i.ibb.co/PTJ09RF/image-16-1.png" alt="" />
                <img className="w-1/6 h-[3.2rem]" src="https://i.ibb.co/HGrdNTB/image-16.png" alt="" />
                <img className="w-1/6 h-[3.2rem]" src="https://i.ibb.co/wRq4K5D/image-17.png" alt="" />
                <img className="w-1/8 h-[2rem]" src="https://i.ibb.co/v1tw3FR/image-20.png" alt="" />
            </div>
        </div>
    );
};
